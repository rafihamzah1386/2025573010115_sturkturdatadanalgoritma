...
const daftarBelanja = ['Beras', 'Gula', 'Minyak Goreng', 'Telur', 'Kopi'];
...
console.log('\nMenambahkan Susu dan Garam ke daftar.');
...
if (adaSusu) {
    console.log('Hasil Cek: Item "Susu" ditemukan di dalam daftar belanja.');
} else {
    console.log('Hasil Cek: Item "Susu" tidak ada di daftar belanja.');
}

console.log(`\nJumlah total item belanja saat ini: ${daftarBelanja.length} item.`);
